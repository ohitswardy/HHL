    ...
    <div className="flex h-screen" style={{ background: 'var(--n-base)' }}>
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <footer
          ...
          style={{
            borderTop: '1px solid var(--n-shadow-dark)',
            background: 'var(--n-surface)',
            boxShadow: '0 -2px 8px var(--n-shadow-dark)',
          }}
        >
          <span
            className="text-xs"
            style={{ color: 'var(--n-text-dim)', fontFamily: 'var(--n-font-body)', letterSpacing: '0.02em' }}
          >
            HardhatLedger 2026 &mdash; All rights reserved for{' '}
            <span style={{ color: 'var(--n-accent)', fontWeight: 600 }}>CW Devs</span>
          </span>
        </footer>
      </div>
