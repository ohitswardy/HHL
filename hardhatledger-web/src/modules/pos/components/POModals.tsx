...
<div class="wrap">
  <div class="header">
    <div>
      <div class="brand">TRI-MILLENNIUM HARDWARE TRADING</div>
  ...
  <div class="footer"><span>HardhatLedger 2026 &mdash; All rights reserved for CW Devs</span><span>${dayjs().format('MMM D, YYYY h:mm A')}</span></div>
</div>`;
